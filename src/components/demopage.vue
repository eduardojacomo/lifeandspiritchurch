...
const serviceTitle = {
  service: {
    en: 'Saturday Celebration',
    pt: 'Celebração de Sábado'
  },
  hour: {
    en: '06:30 PM',
    pt: '18:30'
...
<template>
  <main>
    ...
    <section class="teste">
       <div class="animate-on-scroll slide-in-up">Aparece ao rolar!</div>
        <div class="animate-on-scroll slide-in-up stagger-1">Com delay!</div>
        <div class="animate-on-scroll scale-in stagger-2">Com efeito!</div>
    </section>
  </main>
</template>
