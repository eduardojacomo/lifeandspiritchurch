...
// Filtro simples para atividades (por título ou dia)
...
<template>
  <div class="tab-content active">
      ...
      <div v-for="activity in filteredActivities" :key="activity.id" class="gallery-item">
        ...
        <div class="gallery-info">
          ...
          <div class="gallery-details">
            <strong>Título:</strong> {{ activity.title?.pt }}
          </div>
          
          <div class="gallery-details">
            <strong>Descrição:</strong> {{ truncate(activity.description?.pt || '', 60) }}
          </div>
    ...
    <div v-else class="empty-state">
      ...
      <p>Adicione novas programações na aba "Nova Atividade"</p>
    </div>
      ...
      <div v-if="showDeleteConfirm" class="modal-overlay" @click.self="showDeleteConfirm = false">
        <div class="modal-content delete-confirmation">
          ...
          <div class="modal-body">
            ...
            <p class="warning-text">Esta ação removerá a imagem e os dados permanentemente.</p>
          </div>
